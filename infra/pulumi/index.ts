...
const clusterName = config.get("cluster-name") || "dragon-gke";

// VPC Network
const network = new gcp.compute.Network("dragon-network", {
    autoCreateSubnetworks: false,
    project,
});

const subnet = new gcp.compute.Subnetwork("dragon-subnet", {
...
// GKE Cluster - Zonal, minimal config
const cluster = new gcp.container.Cluster("dragon-cluster", {
    name: clusterName,
    location: zone,
    project,
    network: network.id,
...
const nodePool = new gcp.container.NodePool("dragon-nodes", {
